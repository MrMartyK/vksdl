...
[[nodiscard]] Result<ReflectedLayout> reflectSpv(
    const std::vector<std::uint32_t>& code,
    VkShaderStageFlags stage);

// Reflect a SPIR-V file from disk.
[[nodiscard]] Result<ReflectedLayout> reflectSpvFile(
...
[[nodiscard]] Result<ReflectedLayout> mergeReflections(
    const ReflectedLayout& a,
