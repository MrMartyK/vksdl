...
private:
    ...
    friend Result<void> uploadToBuffer(const Allocator&, const Device&,
                                       const Buffer&, const void*, VkDeviceSize);
    Buffer() = default;
...
[[nodiscard]] Result<void> uploadToBuffer(
...
[[nodiscard]] Result<Buffer> uploadBuffer(
    const Allocator& allocator,
    const Device& device,
...
[[nodiscard]] Result<Buffer> uploadVertexBuffer(
    const Allocator& allocator, const Device& device,
    const void* data, VkDeviceSize size);

[[nodiscard]] Result<Buffer> uploadIndexBuffer(
    const Allocator& allocator, const Device& device,
    const void* data, VkDeviceSize size);
