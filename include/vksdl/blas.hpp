...
struct BlasTriangleGeometry {
    ...
    [[nodiscard]] static BlasTriangleGeometry fromBuffers(
...
private:
    ...
    VkBuildAccelerationStructureFlagsKHR  buildFlags_ = VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR;
...
[[nodiscard]] Result<void> compactBlas(
