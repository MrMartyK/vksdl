...
class PushDescriptorWriter {
  public:
    ...
    PushDescriptorWriter& image(std::uint32_t binding, VkImageView view, VkImageLayout imageLayout,
                                VkSampler sampler,
    ...
    PushDescriptorWriter& buffer(std::uint32_t binding, VkBuffer buf, VkDeviceSize size,
