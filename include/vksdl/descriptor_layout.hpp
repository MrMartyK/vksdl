...
public:
    ...
    DescriptorLayoutBuilder& addUniformBuffer(std::uint32_t binding,
                                              VkShaderStageFlags stageFlags);
    DescriptorLayoutBuilder& addDynamicUniformBuffer(std::uint32_t binding,
                                                     VkShaderStageFlags stageFlags);
    DescriptorLayoutBuilder& addStorageBuffer(std::uint32_t binding,
                                              VkShaderStageFlags stageFlags);
    DescriptorLayoutBuilder& addStorageImage(std::uint32_t binding,
                                             VkShaderStageFlags stageFlags);
