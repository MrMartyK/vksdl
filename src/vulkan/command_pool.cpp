...
CommandPool::CommandPool(CommandPool&& o) noexcept : device_(o.device_), pool_(o.pool_) {
...
Result<CommandPool> CommandPool::create(const Device& device, std::uint32_t queueFamily) {
    CommandPool cp;
