...
BindlessTable::~BindlessTable() { destroy(); }

BindlessTable::BindlessTable(BindlessTable&& o) noexcept
    : device_(o.device_), pool_(o.pool_), layout_(o.layout_),
      set_(o.set_), capacity_(o.capacity_), type_(o.type_) {
...
Result<BindlessTable> BindlessTable::create(
    const Device& device, std::uint32_t capacity,
...
void BindlessTable::writeImage(std::uint32_t index, VkImageView view,
...
void BindlessTable::writeStorageImage(std::uint32_t index, VkImageView view,
...
void BindlessTable::writeBuffer(std::uint32_t index, VkBuffer buffer,
