...
int main() {
    ...
    {
        auto sync = vksdl::TimelineSync::create(device.value(), swapchain.value().imageCount());
        assert(sync.ok());
        ...
        auto [frame, img] = vksdl::acquireTimelineFrame(swapchain.value(), sync.value(),
                                                        device.value(), window.value())
                                .value();
        ...
        vksdl::presentTimelineFrame(device.value(), swapchain.value(), window.value(), sync.value(),
